...
TEST(logic, multiply) {  // NOLINT
...

    {
        ...
        auto a = logic::logic<299, 0>("10001010101111111000101100010101111111111111111111111111111111111111111111111111111100000000000000000");
        auto b = logic::logic<299, 0>("10000001111100011001101011111111111111111111111111111111111111111111111111010101010010110101010100101");
        auto c = a * b;
        EXPECT_EQ(c.str(), "");
    }
}
